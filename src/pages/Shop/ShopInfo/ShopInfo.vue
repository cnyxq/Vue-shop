    ...
    <div class="shop-info">
        <div class="info-content">
            ...
            <section class="section">
                ...
                <div class="activity">
                    <div class="activity-item activity-green" :class="colorClass(item.type)" v-for="(item,index) in shopInfo.supports" :key="index">
            ...
            <section class="section">
                ...
                <div class="pic-wrapper">
                    <ul class="pic-list" ref="picsUl">
                        <li class="pic-item" v-for="(pics,index) in shopInfo.pics" :key="index">
