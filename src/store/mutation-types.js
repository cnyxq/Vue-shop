...
export const RECEIVE_FOODTYPES = 'receive_foodTypes' // 接收食品分类信息
export const RECEIVE_SHOPLIST = 'receive_shopList' // 接收商家列表
export const RECEIVE_USERINFO = 'receive_userInfo' // 接收登录用户信息
export const RESET_USERINFO = 'reset_userInfo' // 清空登录信息
