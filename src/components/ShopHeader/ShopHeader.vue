<template>
    <div class="shop-header">
        ...
        <div class="shop-content" @click="isShowShop">
            ...
            <div class="header-content">
                ...
                <div class="shop-message">
                    ...
                    <span class="shop-message-detail">{{shopInfo.description}}</span>&nbsp;&nbsp;
                    <span class="shop-message-detail">约{{shopInfo.deliveryTime}}分钟</span>&nbsp;&nbsp;
                    <span class="shop-message-detail">距离{{shopInfo.distance}}</span>
                </div>
            </div>
        </div>
        <div class="shop-header-discounts" v-if="shopInfo.supports" @click="isShowSheet">
            ...
            <div class="shop-brief-modal" v-show="showShop">
                <div class="brief-modal-content">
                    ...
                    <div class="mask-footer">
                        <span class="iconfont icon-close" @click="isShowShop"></span>
                    </div>
                </div>
        ...
        <transition name="fade">
            <div class="activity-sheet" v-show="showSheet">
                <div class="activity-sheet-content">
                    ...
                    <ul class="list">
                        <li class="activity-item" :class="supportClass[item.type]" v-for="(item,index) in shopInfo.supports" :key="index">
                        <span class="content-tag">
                    ...
                    <div class="activity-sheet-close">
                        <span class="iconfont icon-close" @click="isShowSheet"></span>
                    </div>
                </div>
